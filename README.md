...
> Math-magic project is a Single Page Application (SPA) created with React that allows users to Make simple calculations and Read a random math-related quote. It is simple and easy to use. Try it!
